...
extern LanguageResolver *find_language_resolver_impl(ReferenceResolver *resolver, LanguageType language);
extern bool reference_resolver_init_builtin_impl(ReferenceResolver *resolver);

// From resolver_resolution.c
extern ResolutionResult reference_resolver_resolve_node_impl(ReferenceResolver *resolver,
...
extern ResolutionResult reference_resolver_generic_resolve_impl(ASTNode *node,
...
bool reference_resolver_register(ReferenceResolver *resolver, LanguageType language,
                               ResolverFunction resolver_func, void *resolver_data,
                               ResolverCleanupFunction cleanup_func) {
    return reference_resolver_register_impl(resolver, language, resolver_func, 
                                          resolver_data, cleanup_func);
}
 ...
 */
ResolutionResult reference_resolver_resolve_node(ReferenceResolver *resolver,
                                              ASTNode *node, ReferenceType ref_type,
                                              const char *qualified_name) {
 ...
 * @see resolver_resolution.c for implementation
 */
size_t reference_resolver_resolve_file(ReferenceResolver *resolver,
                                     ParserContext *file_context) {
 ...
 * @see resolver_resolution.c for implementation
 */
ResolutionResult reference_resolver_generic_resolve(ASTNode *node,
                                                 ReferenceType ref_type,
                                                 const char *name,
                                                 GlobalSymbolTable *symbol_table) {
 ...
 * @see resolver_core.c for implementation
 */
void reference_resolver_get_stats(const ReferenceResolver *resolver,
                                size_t *out_total_references,
                                size_t *out_resolved_references,
                                size_t *out_unresolved_references) {
    reference_resolver_get_stats_impl(resolver, 
                                      out_total_references,
                                      out_resolved_references, 
