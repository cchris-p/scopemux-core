...
def main():
    try:
        ...
        print("Loaded scopemux_core from:", scopemux_core.__file__)
        print(
            "ParserContext.parse_string repr:",
            repr(scopemux_core.ParserContext.parse_string),
        )
        print("type:", type(scopemux_core.ParserContext.parse_string))
        import sys
        ...
        try:
            ...
            for module in sys.modules.values():
                if (
                    ...
                    and module.__file__
                    and "scopemux_core" in module.__file__
                ):
                ...
                if language_id == 1
                    ...
                    if language_id == 2
                        ...
                        if language_id == 3
                            ...
                            "javascript"
                            if language_id == 4
                            else "typescript" if language_id == 5 else "unknown"
                        )
                    )
                )
            )
