 ...
 */
static PyObject* TreeSitterParser_parse_string(TreeSitterParserObject* self, PyObject* args, PyObject* kwds) {
    const char* content;
    ...
    PyObject* tree_capsule = PyCapsule_New(tree, "scopemux_core.TreeSitterTree", (PyCapsule_Destructor)ts_tree_free);
    if (!tree_capsule) {
        ts_tree_free(tree);
        return NULL;
    }
 ...
 */
static PyObject* TreeSitterParser_tree_to_ir(TreeSitterParserObject* self, PyObject* args, PyObject* kwds) {
    ...
    if (!PyObject_TypeCheck(parser_ctx_obj, (PyTypeObject*)PyObject_GetAttrString(PyImport_ImportModule("scopemux_core"), "ParserContext"))) {
        PyErr_SetString(PyExc_TypeError, "Expected a ParserContext object");
        return NULL;
    }
    
    // Extract the parser context from the object
    ParserContext* parser_ctx = ((struct {
        PyObject_HEAD
        ParserContext* ctx;
    }*)parser_ctx_obj)->ctx;
 ...
 */
static PyObject* TreeSitterParser_extract_comments(TreeSitterParserObject* self, PyObject* args, PyObject* kwds) {
    PyObject* tree_capsule;
    PyObject* parser_ctx_obj;
    static char* kwlist[] = {"tree", "parser_ctx", NULL};
 ...
 */
static PyObject* TreeSitterParser_extract_functions(TreeSitterParserObject* self, PyObject* args, PyObject* kwds) {
    PyObject* tree_capsule;
    PyObject* parser_ctx_obj;
    static char* kwlist[] = {"tree", "parser_ctx", NULL};
 ...
 */
static PyObject* TreeSitterParser_extract_classes(TreeSitterParserObject* self, PyObject* args, PyObject* kwds) {
    PyObject* tree_capsule;
    PyObject* parser_ctx_obj;
    static char* kwlist[] = {"tree", "parser_ctx", NULL};
 ...
 */
static PyObject* TreeSitterParser_get_last_error(TreeSitterParserObject* self, PyObject* Py_UNUSED(args)) {
...
static PyMethodDef TreeSitterParser_methods[] = {
    ...
    {"extract_comments", (PyCFunction)TreeSitterParser_extract_comments, METH_VARARGS | METH_KEYWORDS, 
     "Extract comments and docstrings from a Tree-sitter syntax tree"},
    {"extract_functions", (PyCFunction)TreeSitterParser_extract_functions, METH_VARARGS | METH_KEYWORDS, 
     "Extract functions and methods from a Tree-sitter syntax tree"},
...
static PyTypeObject TreeSitterParserType = {
    ...
    .tp_name = "scopemux_core.TreeSitterParser",
