 ...
 */
static PyObject* ContextEngine_add_parser_context(ContextEngineObject* self, PyObject* args, PyObject* kwds) {
    ...
    if (!PyObject_TypeCheck(py_parser_ctx, (PyTypeObject*)PyObject_GetAttrString(PyImport_ImportModule("scopemux_core"), "ParserContext"))) {
 ...
 */
static PyObject* ContextEngine_rank_blocks(ContextEngineObject* self, PyObject* args, PyObject* kwds) {
    ...
    if (!PyArg_ParseTupleAndKeywords(args, kwds, "sII|s", kwlist, &cursor_file, &cursor_line, &cursor_column, &query)) {
        return NULL;
    }
    
    bool success = context_engine_rank_blocks(self->engine, cursor_file, cursor_line, cursor_column, query);
    if (!success) {
 ...
 */
static PyObject* ContextEngine_estimate_tokens(ContextEngineObject* self, PyObject* args, PyObject* kwds) {
    const char* text;
 ...
 */
static PyObject* ContextEngine_update_focus(ContextEngineObject* self, PyObject* args, PyObject* kwds) {
    ...
    // Update focus
    size_t num_updated = context_engine_update_focus(self->engine, node_names, num_nodes, focus_value);
    free(node_names);
 ...
 */
static PyObject* ContextEngine_reset_compression(ContextEngineObject* self, PyObject* Py_UNUSED(args)) {
...
static PyMethodDef ContextEngine_methods[] = {
    {"add_parser_context", (PyCFunction)ContextEngine_add_parser_context, METH_VARARGS | METH_KEYWORDS, 
     "Add all nodes from a parser context to the context engine"},
...
static PyTypeObject ContextEngineType = {
    ...
    .tp_name = "scopemux_core.ContextEngine",
...
static PyObject* InfoBlock_get_relevance(InfoBlockObject* self, void* closure) {
    ...
    PyDict_SetItemString(relevance_dict, "recency", PyFloat_FromDouble(self->block->relevance.recency));
    PyDict_SetItemString(relevance_dict, "cursor_proximity", PyFloat_FromDouble(self->block->relevance.cursor_proximity));
    PyDict_SetItemString(relevance_dict, "semantic_similarity", PyFloat_FromDouble(self->block->relevance.semantic_similarity));
    PyDict_SetItemString(relevance_dict, "reference_count", PyFloat_FromDouble(self->block->relevance.reference_count));
    PyDict_SetItemString(relevance_dict, "user_focus", PyFloat_FromDouble(self->block->relevance.user_focus));
...
static PyObject* InfoBlock_get_ir_node(InfoBlockObject* self, void* closure) {
    ...
    PyTypeObject* ir_node_type = (PyTypeObject*)PyObject_GetAttrString(PyImport_ImportModule("scopemux_core"), "IRNode");
    if (!ir_node_type) {
        return NULL;
    }
...
static PyGetSetDef InfoBlock_getsetters[] = {
    ...
    {"compressed_tokens", (getter)InfoBlock_get_compressed_tokens, NULL, "Compressed token count", NULL},
    {"compression_level", (getter)InfoBlock_get_compression_level, NULL, "Current compression level", NULL},
    {"relevance", (getter)InfoBlock_get_relevance, NULL, "Relevance metrics for ranking", NULL},
    {"compressed_content", (getter)InfoBlock_get_compressed_content, NULL, "Compressed content", NULL},
...
static PyTypeObject InfoBlockType = {
    PyVarObject_HEAD_INIT(NULL, 0)
    .tp_name = "scopemux_core.InfoBlock",
