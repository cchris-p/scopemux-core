 ...
 */
bool context_engine_rank_blocks(ContextEngine* engine, 
 ...
 */
size_t context_engine_get_context(const ContextEngine* engine, 
                                 char* out_buffer, 
                                 size_t buffer_size);
 ...
 */
size_t context_engine_estimate_tokens(const ContextEngine* engine, 
                                     const char* text, 
                                     size_t text_length);
 ...
 * @return bool True on success, false on failure
 */
bool context_engine_compress_block(ContextEngine* engine, 
                                  InfoBlock* block, 
 ...
 */
size_t context_engine_update_focus(ContextEngine* engine, 
                                  const char** node_qualified_names, 
                                  size_t num_nodes, 
                                  float focus_value);
