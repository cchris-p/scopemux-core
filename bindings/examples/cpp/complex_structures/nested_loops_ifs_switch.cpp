...
int process_nested_data(const std::vector<std::vector<int>>& data) {
    ...
    for (size_t i = 0; i < data.size(); ++i) {
        ...
        for (size_t j = 0; j < row.size(); ++j) {
            ...
            if (value < 0) {
                std::cout << "  Skipping negative value at [" << i << "][" << j << "]: " << value << std::endl;
                continue;
            }
            ...
            if (value == 0) {
                ...
                std::cout << "  Processing small value at [" << i << "][" << j << "]: " << value << std::endl;
                ...
                std::cout << "  Processing large value at [" << i << "][" << j << "]: " << value << std::endl;
