...
Test(cpp_parsing, tree_sitter_initialization, .description = "Test Tree-sitter parser initialization for C++") {
...
Test(python_parsing, tree_sitter_initialization, .description = "Test Tree-sitter parser initialization for Python") {
